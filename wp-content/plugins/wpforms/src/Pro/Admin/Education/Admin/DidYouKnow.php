...
class DidYouKnow implements EducationInterface {
	...
	public function messages() {
		...
		return [
			...
			[
				'desc' => esc_html__( 'You can easily integrate your forms with 4,000+ useful apps by using WPForms + Zapier.', 'wpforms' ),
				'more' => 'https://wpforms.com/addons/zapier-addon/',
				'item' => 2,
			],
			[
				'desc' => esc_html__( 'You can integrate your forms to automatically send entries to your most used apps. Perfect for users of Salesforce, Slack, Trello, and 4,000+ others.', 'wpforms' ),
				'more' => 'https://wpforms.com/addons/zapier-addon/',
				'item' => 3,
			],
			[
